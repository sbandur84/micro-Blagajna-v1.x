...
Openbravo, Openbravo POS Community Members and mikroBLAGAJNA, and we appreciate and 
...
mikroBLAGAJNA  supports 15 languages.

English UK is the default language set.

Not all locales are completely translated

The locale files shipped with this version of mikroBLAGAJNA  are the latest at the date of this release.

Latest locales can be found here: www.mikroBLAGAJNA.com/downloads
...
You will find the files in the mikroBLAGAJNA  installation folder in the
\reports\com\openbravo\reports

HOW TO CHANGE YOUR LANGUAGE
1. Copy the locale you need from the language sub-folder \locales\languagename
   into the \mikroBLAGAJNA\locales parent folder
2. Copy the content of reports folder from the language sub-folder
   \locales\languagename\reports folder into the \mikroBLAGAJNA\reports folder 
3. Set the mikroBLAGAJNA  Configuration>Locale to your required language