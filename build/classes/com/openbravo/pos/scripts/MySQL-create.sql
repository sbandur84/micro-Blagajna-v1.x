...
INSERT INTO ROLES(ID, NAME, PERMISSIONS) VALUES('0', 'Administratorja', $FILE{/com/openbravo/pos/templates/Role.Administrator.xml} );
INSERT INTO ROLES(ID, NAME, PERMISSIONS) VALUES('1', 'Upravitelj', $FILE{/com/openbravo/pos/templates/Role.Manager.xml} );
INSERT INTO ROLES(ID, NAME, PERMISSIONS) VALUES('2', 'Zaposleni', $FILE{/com/openbravo/pos/templates/Role.Employee.xml} );
INSERT INTO ROLES(ID, NAME, PERMISSIONS) VALUES('3', 'Gost', $FILE{/com/openbravo/pos/templates/Role.Guest.xml} );
...
INSERT INTO PEOPLE(ID, NAME, APPPASSWORD, ROLE, VISIBLE, IMAGE) VALUES ('1', 'Upravitelj', NULL, '1', TRUE, NULL);
INSERT INTO PEOPLE(ID, NAME, APPPASSWORD, ROLE, VISIBLE, IMAGE) VALUES ('2', 'Zaposleni', NULL, '2', TRUE, NULL);
INSERT INTO PEOPLE(ID, NAME, APPPASSWORD, ROLE, VISIBLE, IMAGE) VALUES ('3', 'Gost', NULL, '3', TRUE, NULL);
...
INSERT INTO TAXES(ID, NAME, CATEGORY, CUSTCATEGORY, PARENTID, RATE, RATECASCADE, RATEORDER) VALUES ('000', 'DDV 22%t', '000', NULL, NULL, 0.22, FALSE, NULL);
INSERT INTO TAXES(ID, NAME, CATEGORY, CUSTCATEGORY, PARENTID, RATE, RATECASCADE, RATEORDER) VALUES ('001', 'DDV 9,5%', '001', NULL, NULL, 0.095, FALSE, NULL);
INSERT INTO TAXES(ID, NAME, CATEGORY, CUSTCATEGORY, PARENTID, RATE, RATECASCADE, RATEORDER) VALUES ('002', 'Brez DDV', '002', NULL, NULL, 0.0, FALSE, NULL);
...
CREATE TABLE PRODUCTS (
    ...
    NAME VARCHAR(255) NOT NULL,
    PRICEBUY DOUBLE DEFAULT 1 NOT NULL,
    PRICESELL DOUBLE DEFAULT 2 NOT NULL,
    CATEGORY VARCHAR(255) NOT NULL,
...
VALUES ('100001', '100001', '100001', 'CocaCola 0,5l ploč', '000', '001', 0);
...
CREATE TABLE RESERVATIONS (
    ...
    DATENEW DATETIME DEFAULT '2014-14-05 00:00:00' NOT NULL,
